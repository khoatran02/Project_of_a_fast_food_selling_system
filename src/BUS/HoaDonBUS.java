...
//    // Tìm hóa đơn lập gần nhất
//    public static int LapHoaDonCuoi(){
//        int SoHH = 0;
//        for (int i = 0; i < HD.size(); i++)
//        {
//            for (int j = i+1; j < HD.size(); j++) {
//                if (Integer.parseInt(HD.get(i).getIDHoaDon().substring(3)) < Integer.parseInt(HD.get(j).getIDHoaDon().substring(3))){
//                    SoHH = Integer.parseInt(HD.get(j).getIDHoaDon().substring(3));
//                }
//            }
//        }
//        return SoHH;
...
//    public static String tangMa(int SoHH)
//    {
//        String maChu = "HD"; //lấy HD
//        int maSo1= SoHH+ 1;//tăng 12+1
